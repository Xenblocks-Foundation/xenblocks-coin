...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xenblocks-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xenblocks-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xenblocks transaction") + "\n" +
              "  xenblocks-tx [options] -create [commands]   " + _("Create hex-encoded xenblocks transaction") + "\n" +
              "\n";
