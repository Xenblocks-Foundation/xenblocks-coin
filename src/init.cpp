...
void Shutdown()
{
    ...
    RenameThread("xenblocks-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/xenblocks-project/xenblocks>";
    const std::string URL_WEBSITE = "<https://xenblocks.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("xenblocks-loadblk");
    CImportingNow imp;
